...
def conv_strat_latlon(dbz, lat2d, lon2d, CoreThresh=42.0, method='SYH', a=10, b=100, tune_thresh=46.0, sm_rad=15, fill_dbz=25.0, bg_diff=11):
    ...
    print(np.shape(In1),np.shape(cc),np.shape(bkgnd))
