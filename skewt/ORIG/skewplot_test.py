...
#file_path = '/home/disk/shear2/brodzik/python/skewt/test_in' # location of sounding files
#out_path = '/home/disk/shear2/brodzik/python/skewt/test_out' # where you want to output skewTs
...
#fmt = 'EDT' # This can currently be 'EC' for Canadian format, 'UWYO' for Wyoming soundings or 'EDT' for Vaisala CSU soundings

file_path = '/home/disk/shear2/brodzik/python/skewt/test_in' # location of sounding files
out_path = '/home/disk/shear2/brodzik/python/skewt/test_out' # where you want to output skewTs
prefix = '18' # the first part of the sounding raw data file, need it to search for possible files
                    # other possibilities are 'K' for K*** UWYO soundings, could also be 'EDT' for Vaisala soundings
fmt = 'SMN' # This can currently be 'EC' for Canadian format, 'UWYO' for Wyoming soundings, 'EDT' for Vaisala CSU soundings
            # or 'SMN' for Argentinian soundings
...
for fname in sounding_files:
    ...
    if fmt == 'SMN':
        fnameParts = base_fname.split('_')
        datetime = '20'+fnameParts[0]+fnameParts[1]+'00' 
        date = datetime[:8]
    else:
