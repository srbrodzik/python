...
outdir = '/home/disk/bob/gpm/nam_ku/zeb-data/trmm_sim_p'
...
for fname in os.listdir(indir):
    ...
    if fname.startswith('acme_cmdv_test1.2008-05'):
        ...
        z = ncid.createDimension('altitude',lev_in.size)
        ...
        alt.units = 'hPa'
        alt.long_name = 'hybrid level at midpoints (1000*(A+B))'
