...
(http://dirac.cnrs-orleans.fr/ScientificPython/)
or the 'classic' version of the netCDF4 interface. 
...
"""
# open a new netCDF file for writing (default is format = 'NETCDF4')
ncfile = Dataset('simple_xy.nc','w',format='NETCDF4_CLASSIC')
print ncfile.data_model

# create an output array that will be nx x ny
nx = 6; ny = 12
