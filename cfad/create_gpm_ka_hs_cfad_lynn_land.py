...
inDir = '/home/disk/bob/gpm/n1_oly_lynn_land_ka_hs/classify/ex_data'
#inDir = '/home/disk/bob/gpm/n1_oly_lynn_land_ka_hs/classify/ex_data/SMALLEST_DOMAIN'
outDir = inDir
...
# output cfad arrays
fid_cfad_total = open(outDir+'/gpm-ka_cfad_lynn_land_total_NEW.txt','w')
#fid_cfad_total = open(outDir+'/gpm-ku_cfad_lynn_land_total_adj.txt','w')
#fid_cfad_stra = open(outDir+'/gpm-ku_cfad_lynn_land_stra_adj.txt','w')
#fid_cfad_conv = open(outDir+'/gpm-ku_cfad_lynn_land_conv_adj.txt','w')
#fid_cfad_other = open(outDir+'/gpm-ku_cfad_lynn_land_other_adj.txt','w')
...
## for testing only
#fid_cfad_total_sub = open(outDir+'/gpm-ku_cfad_lynn_land_total_10-50_NEW.txt','w')
#for ilevel in range(0,numLevels):
