...
# output cfad array
fid_cfad_total = open(outDir+'gpm-ku_cfad_total.txt','w')
fid_cfad_stra = open(outDir+'gpm-ku_cfad_stra.txt','w')
fid_cfad_conv = open(outDir+'gpm-ku_cfad_conv.txt','w')
fid_cfad_other = open(outDir+'gpm-ku_cfad_other.txt','w')
