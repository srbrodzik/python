'''
plot_cfad_gpm_over_ocean_lynn.py
...
#title = 'GPMKu (VancIsl) Over Ocean Norm By Level CFAD'
#title = 'GPMKu (NOre) Over Ocean Norm By Level CFAD'
#title = 'GPMKu (SOre) Over Ocean Norm By Level CFAD'
#title = 'GPMKu (NCa) Over Ocean Norm By Level CFAD'
#title = 'GPMKu (CCa) Over Ocean Norm By Level CFAD'
title = 'GPMKu (SCa) Over Ocean Norm By Level CFAD'
...
if apply_filter:
    outfile = 'gpm-ku_cfad_lynn_ocean_total_'+str(int(min_refl_for_plot))+'db_bylevel_filtered.eps'
else:
    outfile = 'gpm-ku_cfad_lynn_ocean_total_'+str(int(min_refl_for_plot))+'db_bylevel.eps'
