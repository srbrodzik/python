...
title = 'GPMKu Over Ocean Norm CFAD'
...
#outfile = 'gpm-ku-over-ocean_cfad_total_adj_'+str(int(min_refl_for_plot))+'db_test.png'
outfile = 'gpm-ku-over-ocean_cfad_total_raw_'+str(int(min_refl_for_plot))+'db_test.png'
