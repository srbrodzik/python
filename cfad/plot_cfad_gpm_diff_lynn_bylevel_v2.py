...
#title = 'GPMKu (VancIsl) Land-Ocean Norm By Level CFAD'
#title = 'GPMKu (NOre) Land-Ocean Norm By Level CFAD'
#title = 'GPMKu (SOre) Land-Ocean Norm By Level CFAD'
#title = 'GPMKu (NCa) Land-Ocean Norm By Level CFAD'
#title = 'GPMKu (CCa) Land-Ocean Norm By Level CFAD'
title = 'GPMKu (SCa) Land-Ocean Norm By Level CFAD'
...
if apply_filter:
    outfile = 'gpm-ku_cfad_lynn_diff_total_'+str(int(min_refl_for_plot))+'db_bylevel_filtered.eps'
else:
    outfile = 'gpm-ku_cfad_lynn_diff_total_'+str(int(min_refl_for_plot))+'db_bylevel.eps'
