...
indir = '/home/disk/bob/olympex/zebra/moments/d3r_ku/rhi'
outdir = indir
#title = 'D3R Ku Total Normalized CFAD (DBZ)'
#title = 'D3R Ku East Normalized CFAD (DBZ)'
#title = 'D3R Ku West Normalized CFAD (DBZ)'
title = 'D3R Ku East-West Normalized CFAD (DBZ)'
#outfile = 'd3r_ku_dbz_cfad_total.png'
#outfile = 'd3r_ku_dbz_cfad_east.png'
#outfile = 'd3r_ku_dbz_cfad_west.png'
outfile = 'd3r_ku_dbz_cfad_east-west.png'
...
if type == 'diff':
    ...
    #read text files
    infile1 = indir+'/d3r_ku_dbz_cfad_east.txt'
#    infile1 = indir+'/d3r_ku_zdr_cfad_east.txt'
    rawdata1 = np.loadtxt(infile1)
    infile2 = indir+'/d3r_ku_dbz_cfad_west.txt'
#    infile2 = indir+'/d3r_zdr_cfad_west.txt'
    ...
    #read text file
    #infile = indir+'/d3r_ku_dbz_cfad_total.txt'
    #infile = indir+'/d3r_ku_dbz_cfad_east.txt'
    infile = indir+'/d3r_ku_dbz_cfad_west.txt'
    #infile = indir+'/d3r_ku_zdr_cfad_west.txt'
...
#bin dimensions
# for refl
#xcenter = np.linspace(0.5,49.5,50)    # 0 - 50
xcenter = np.linspace(-14.5,49.5,65)  # -15 - 50
...
if type == 'single':
    ...
    cbar_levels = np.linspace(-0.15,0.15,13)  #dbz
...
ax0.set_ylim(1,8)
# for refl
#ax0.set_xlim(0,50)    # 0 - 50
#ax0.set_xlim(-15,50)  # -15 - 50
ax0.set_xlim(-15,35)  # -15 - 35
# for zdr
