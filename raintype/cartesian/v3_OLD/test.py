...
If you run
>> python -W test.py
after installing the package and dependencies (see Readme file), then this file 
should run without problems (takes only a couple of seconds). The variable raintype 
will contain the classification. You can plot it if you want. 
...
#(A,B) = raintype.raintype('spolka.20111018_163032.nc','/local-scratch/raintype_install',
#                          -9999,1,20,40,28,43,46,7,5,10,8,50,2000)
