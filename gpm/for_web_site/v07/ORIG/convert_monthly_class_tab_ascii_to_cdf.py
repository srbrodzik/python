...
if region == 'AFC':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/afc_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/afc_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Africa'
    limits = [-40.,-30.,40.,60.]   # [minLat,minLon,maxLat,maxLon]
elif region == 'AKA':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/aka_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/aka_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Alaska'
    limits = [35.,-178.,67.,-115.] # [minLat,minLon,maxLat,maxLon]
elif region == 'CIO':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/cio_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/cio_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Central Indian Ocean'
    limits = [-40.,55.,10.,110.]   # [minLat,minLon,maxLat,maxLon]
elif region == 'EPO':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/epo_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/epo_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'East Pacific Ocean'
    limits = [-67.,-178.,45.,-130.]# [minLat,minLon,maxLat,maxLon]
elif region == 'EUR':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/eur_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/eur_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Europe'
    limits = [35.,-20.,67.,45.]    # [minLat,minLon,maxLat,maxLon]
elif region == 'H01':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/h01_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/h01_ku/classify/class_data_v07/monthly_class_v12m' 
    region_long = 'Hole 01 (West Pacific Ocean)'
    limits = [-67.,-140.,25.,-85.] # [minLat,minLon,maxLat,maxLon]
elif region == 'H02':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/h02_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/h02_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Hole 02 (North Atlantic Ocean)'
    limits = [15.,-65.,67.,-10.]   # [minLat,minLon,maxLat,maxLon]
elif region == 'H03':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/h03_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/h03_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Hole 03 (South of Africa)'
    limits = [-67.,-30.,-35.,75.]  # [minLat,minLon,maxLat,maxLon]
elif region == 'H04':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/h04_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/h04_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Hole 04 (South Indian Ocean)'
    limits = [-67.,70.,-35.,178.]  # [minLat,minLon,maxLat,maxLon]
elif region == 'H05':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/h05_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/h05_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'Hole 05 (Western Pacific)'
    limits = [5.,125.,40.,178.]  # [minLat,minLon,maxLat,maxLon]
elif region == 'NAM':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/nam_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/nam_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'North America'
    limits = [15.,-140.,67.,-55.]  # [minLat,minLon,maxLat,maxLon]
elif region == 'NAS':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/nas_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/nas_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'North Asia'
    limits = [35.,40.,67.,178.]    # [minLat,minLon,maxLat,maxLon]
elif region == 'SAM':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/sam_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/sam_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'South America'
    limits = [-67.,-95.,20.,-25.]  # [minLat,minLon,maxLat,maxLon]
elif region == 'SAS':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/sas_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/sas_ku/classify/class_data_v07/monthly_class_v12m'
    region_long = 'South Asia'
    limits = [5.,55.,40.,130.]     # [minLat,minLon,maxLat,maxLon]
elif region == 'WMP':
    if thresLevel == 'str':
        inDir = '/home/disk/bob/gpm/wmp_ku/classify/class_data_v07/monthly_class_v12s'
    elif thresLevel == 'mod':
        inDir = '/home/disk/bob/gpm/wmp_ku/classify/class_data_v07/monthly_class_v12m'
