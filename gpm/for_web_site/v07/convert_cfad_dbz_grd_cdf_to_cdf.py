...
if thresLevel == 'str':
    inDir = '/home/disk/bob/gpm/'+regionDict[region]['subdir']+'/classify/class_data_v07/stats_class_v12s/Cfad'
elif thresLevel == 'mod':
    inDir = '/home/disk/bob/gpm/'+regionDict[region]['subdir']+'/classify/class_data_v07/stats_class_v12m/Cfad'
