...
path = '/home/disk/shear2/brodzik/python/goes-r/DATA/OR_ABI-L2-CMIPF-M3C09_G16_s20171141845379_e20171141856152_c20171141856233.nc'
...
cpt = loadCPT('/home/disk/shear2/brodzik/python/colors/WVCOLOR35.cpt')
...
bmap.imshow(data, origin='upper', vmin=170, vmax=375, cmap=cpt_convert)
...
# Insert a shapefile
bmap.readshapefile('/home/disk/shear2/brodzik/python/goes-r/DATA/ShapeFiles/BRA_adm1','BRA_adm1',linewidth=0.3,color='black')
...
# Export result
#DPI = 150
plt.savefig('/home/disk/shear2/brodzik/python/goes-r/PLOTS/goes-part5-cpt-WV.png', dpi=DPI, bbox_inches='tight', pad_inches=0)
