...
# SRB: IS THIS THE SAME FOR GOES17??
...
sourcePrj.ImportFromProj4('+proj=geos +h=35786023.0 +a=6378137.0 +b=6356752.31414 +f=0.00335281068119356027 +lat_0=0.0 +lon_0=-75.2 +sweep=x +no_defs')
...
def remap(path, extent, resolution, driver):
    ...
    # SRB: I DON'T UNDERSTAND THIS SYNTAX & CAN'T FIND AN EXPLANATION
    if(driver == 'NETCDF'):
    ...
    # SRB; THESE LINES DON'T SEEM TO DO ANYTHING
    # IF I PRINT raw.GetProjection AND raw.getGeoTransform BEFORE AND AFTER
