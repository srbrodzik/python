...
bmap.imshow(data, origin='upper', vmin=170, vmax=360, cmap=cpt_convert)
...
# Insert a shapefile
bmap.readshapefile('/home/disk/shear2/brodzik/python/goes-r/DATA/ShapeFiles/Brazil/BRA_adm1','BRA_adm1',linewidth=0.3,color='black')
...
# Export result
#DPI = 150
plt.savefig('/home/disk/shear2/brodzik/python/goes-r/PLOTS/goes-part5-cpt-Brasil.png', dpi=DPI, bbox_inches='tight', pad_inches=0)
