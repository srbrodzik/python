...
#########################################
# To download a single file use this command (using M1 sector example and vars as defined in this function
#      aws s3 --no-sign-request cp s3://noaa-goes16/ABI-$PRODUCT/$YEAR/$DAY/$HOUR/OR_ABI-L1b-RadM1-M6C02_G16_s20200381802143_e20200381802201_c20200381802240.nc  ./
# e.g. aws s3 --no-sign-request cp s3://noaa-goes16/ABI-L1b-RadM/2020/038/18/OR_ABI-L1b-RadM1-M6C02_G16_s20200381802143_e20200381802201_c20200381802240.nc  ./
#########################################
