...
url = 'https://engineering.arm.gov/~radar/amf1_sacr_incoming_images/kasacr/hsrhi/'+date+'/'
ext = 'png'
outDir = '/home/storm/relops/radar/kasacr/'+date
category = 'radar'
platform = 'DOE_KaSACR'
...
for hour in hours:
    ...
    if debug:
        print >>sys.stderr, "  Processing hour = ", hour
