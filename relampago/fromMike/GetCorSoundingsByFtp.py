...
def parseArgs():
    ...
    parser.add_option('--sourceDir',
                      dest='sourceDir',
                      default='/sounding/SMN/COR',
                      help='Path of source directory')
    parser.add_option('--targetDir',
                      dest='targetDir',
                      default='/home/storm/relops/soundings/SMN/COR'
                      help='Path of target directory')
    parser.add_option('--tmpDir',
                      dest='tmpDir',
                      default='/tmp/soundings/COR',
                      help='Path of tmp directory')
    parser.add_option('--ftpCatServer',
                      dest='ftpCatServer',
                      default='catalog.eol.ucar.edu',
                      help='Name of catalog ftp server host')
    parser.add_option('--ftpCatUser',
                      dest='ftpCatUser',
                      default='anonymous',
                      help='User for catalog ftp host')
    parser.add_option('--ftpCatTargetDir',
                      dest='ftpCatTargetDir',
                      default='/pub/incoming/catalog/relampago',
                      help='Path of ftp catalog target dir')
    ...
    if (options.debug):
        ...
        print >>sys.stderr, "  ftpCatServer: ", options.ftpCatServer
        print >>sys.stderr, "  ftpCatUser: ", options.ftpCatUser
        print >>sys.stderr, "  ftpCatTargetDir: ", options.ftpCatTargetDir
