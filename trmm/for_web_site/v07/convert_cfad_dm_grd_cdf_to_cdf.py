...
if thresLevel == 'str':
    inDir = '/home/disk/bob/trmm/'+regionDict[region]['subdir']+'/classify/class_data_v07/stats_class_v12s/Cfad_Dm'
elif thresLevel == 'mod':
    inDir = '/home/disk/bob/trmm/'+regionDict[region]['subdir']+'/classify/class_data_v07/stats_class_v12m/Cfad_Dm'
