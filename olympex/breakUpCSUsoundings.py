...
indir = '/home/disk/funnel/olympex/data_archive/Soundings_QCed/OLYMPEX_upaL4.0_npol_indivFiles'
infile = 'OLYMPEX_upaL4.0_npol'
outdir = indir
...
for i in range(len(indices)-1):
    ...
    outfile = 'csu.20'+dateTime[1]+'.'+dateTime[2]+'.txt'
    print outfile
