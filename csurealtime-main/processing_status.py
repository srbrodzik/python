...
#	myFont = Font(family="Times New Roman", size=12)
    ...
    def show_values(self):
        ...
        polar_check = sorted(glob.glob('%s/raw_ppi/*%04d*.png'%(fig_path, self.time.year)))
        ...
        rhi_check = sorted(glob.glob('%s/raw_rhi/*%04d*.png'%(fig_path, self.time.year)))
        ...
        rain_check = sorted(glob.glob('%s/rain/*%04d*.png'%(fig_path, self.time.year)))
