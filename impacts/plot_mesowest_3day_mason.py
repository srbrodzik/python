...
print(filetimestamp,monthtimestamp,graphtimestamp,daytimestamp,hourtimestamp,monthonlytimestamp,yyyymm)
...
def make_3day_plot(site,sitetitle,pytime,temp,wind_spd,wind_gust,wind_dir,prec_accum,altimeter,mslp):
    ...
    ##saving files
    #os.chdir("/home/disk/meso-home/jzagrod/public_html/olympex/wxdata/archive/"+site+"/")
    #os.system('mkdir -p ' + yyyymm)
    #outdir_archive = '/home/disk/meso-home/jzagrod/public_html/olympex/wxdata/archive/'+site+'/'
    #outdir_realtime = '/home/disk/meso-home/jzagrod/public_html/olympex/wxdata/real_time/'
    ...
    outdir = '/home/disk/meso-home/masonf3/IMPACTS/asos_test/'
    plt.savefig(outdir+site+'_weather_3day_realtime.png',bbox_inches='tight')
